...
$subject = 'Experion Nova at Windchants - Customer Enquiry';
$emailadd = 'query@aadharhomes.com';
$default_project = 'Experion Nova at Windchants - Sector 112 Gurgaon';
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    elseif (!preg_match('/^[0-9]{10}$/', $mobile)) { $errors[] = 'Phone number must be 10 digits'; }
